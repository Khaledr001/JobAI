...
const CODE_TO_STATUS: Record<string, number> = {
  ...
  [ERROR_CODES.SOURCE_SCHEMA_DRIFT]: HttpStatus.BAD_REQUEST,
  [ERROR_CODES.DOCUMENT_VALIDATION_FAILED]: HttpStatus.BAD_REQUEST,
  [ERROR_CODES.ILLEGAL_APPLICATION_TRANSITION]: HttpStatus.CONFLICT,
